package com.sxjs.jd.composition.main.Order_cn.ywcfragment;
...
public class YwcFragment  extends BaseFragment implements AutoListView.OnRefreshListener ,AutoListView.OnLoadListener {
    String tag="YwcFragment";
    @BindView(R.id.Ywc_Al1)
    AutoListView autoListView;
    @BindView(R.id.Ywc_view_emp)
    LinearLayout linearLayout;
    YwcAdapter ywcAdapter;
    int Pageindex=1;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View view=inflater.inflate(R.layout.ywcfragment,null);
    ...
    public void getdata(int pageindex){
        Log.d(tag,"getdata");
        getAppComponent().getDataManager().getHaveFinishedOrderInfoByUserIdAndPageindex(new DisposableObserver<MyOrderInfo>() {
            @Override
    ...
    public void setdata(MyOrderInfo myOrderInfo) {
        ...
        if(OrderInfoslist!=null&&OrderGoodslist!=null){
            if(ywcAdapter ==null){
                ...
                ywcAdapter=new YwcAdapter(getActivity(),OrderInfoslist,OrderGoodslist);
                autoListView.setAdapter(ywcAdapter);
            }
            else{
                Log.d(tag,"setdata:"+"dfkAdapter.putdata");
                ywcAdapter.putdata(OrderInfoslist,OrderGoodslist);
