package com.sxjs.jd.composition.main.Order_cn.dshfragment;
...
public class DshFragment extends BaseFragment implements AutoListView.OnRefreshListener ,AutoListView.OnLoadListener  {
    String tag="DshFragment";
    @BindView(R.id.Dsh_Al1)
    AutoListView autoListView;
    @BindView(R.id.Dsh_view_emp)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View view=inflater.inflate(R.layout.dshfragment,null);
    ...
    public void getdata(int pageindex){
        Log.d(tag,"getdata");
        getAppComponent().getDataManager().getWaitShipOrderInfoByUserIdAndPageindex(new DisposableObserver<MyOrderInfo>() {
            @Override
    ...
    public void setdata(MyOrderInfo myOrderInfo) {
        ...
        if(OrderInfoslist!=null&&OrderGoodslist!=null){
            if(dshAdapter ==null){
                ...
                dshAdapter=new DshAdapter(getActivity(),OrderInfoslist,OrderGoodslist);
                autoListView.setAdapter(dshAdapter);
            }
            else{
                Log.d(tag,"setdata:"+"dfkAdapter.putdata");
                dshAdapter.putdata(OrderInfoslist,OrderGoodslist);
                dshAdapter.notifyDataSetChanged();
            }
        }
