...
public class DfkAdapter extends BaseAdapter {
    ...
    public DfkAdapter(Activity activity, List<MyOrderInfo.ItemsBean.ItemListBean.OrderInfosBean> OrderInfoslist, List<MyOrderInfo.ItemsBean.ItemListBean.OrderGoodsBean> OrderGoodslist){
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        button=(Button)view.findViewById(R.id.com_recyler_item_bqzf);
    ...
    public void setOnItemClickListener(){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(activity,"去支付", Toast.LENGTH_SHORT).show();
            }
        });
    }
