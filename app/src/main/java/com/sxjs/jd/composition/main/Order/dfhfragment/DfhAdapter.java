...
//import com.example.administrator.order.ComRereAdapter;
//import com.example.administrator.order.Detail;
//import com.example.administrator.order.R;
import com.google.gson.Gson;
import com.sxjs.common.base.baseadapter.BaseQuickAdapter;
import com.sxjs.common.bean.MyOrderInfo;
import com.sxjs.jd.R;
import com.sxjs.jd.composition.main.Order.ComRereAdapter;
import com.sxjs.jd.composition.main.Order.Detail;
...
public class DfhAdapter extends BaseAdapter {
    ...
    public DfhAdapter(Activity activity, List<MyOrderInfo.ItemsBean.ItemListBean.OrderInfosBean> OrderInfoslist, List<MyOrderInfo.ItemsBean.ItemListBean.OrderGoodsBean> OrderGoodslist){
        Log.d(tag,"DfhAdapter(Activity activity,");
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        button=(Button)view.findViewById(R.id.com_recyler_item_btxfh);
        ...
        MyOrderInfo.ItemsBean.ItemListBean.OrderInfosBean orderInfosBean=Infoslist.get(position);
