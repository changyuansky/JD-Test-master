...
public class YwcAdapter extends BaseAdapter {
    ...
    public YwcAdapter(Activity activity, List<MyOrderInfo.ItemsBean.ItemListBean.OrderInfosBean> OrderInfoslist, List<MyOrderInfo.ItemsBean.ItemListBean.OrderGoodsBean> OrderGoodslist){
        Log.d(tag,"YwcAdapter(Activity activity,");
