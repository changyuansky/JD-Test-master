package com.sxjs.jd.composition.main.Order.dshfragment;
...
public class DshAdapter extends BaseAdapter {

    String tag="DshFragment";
    ...
    public DshAdapter(Activity activity, List<MyOrderInfo.ItemsBean.ItemListBean.OrderInfosBean> OrderInfoslist, List<MyOrderInfo.ItemsBean.ItemListBean.OrderGoodsBean> OrderGoodslist){
        Log.d(tag,"DshAdapter(Activity activity,");
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        button=(Button)view.findViewById(R.id.com_recyler_item_bqrsh);
